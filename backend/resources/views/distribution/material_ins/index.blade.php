...
@section('title', 'List Bahan Masuk')
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Daftar Bahan Masuk</h3>
                        </div>
                        <div class="card-body">
                            <table id="example2" class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $material_in->quantity }} {{ $material_in->ingredient->unit }}</td>
            ...
            buttons: [
                {
                    ...
                    action: function (e, dt, node, config) {
                        window.location.href = '{{ route("material_ins.create") }}';
                    }
                },
                {
                    extend: 'copy',
